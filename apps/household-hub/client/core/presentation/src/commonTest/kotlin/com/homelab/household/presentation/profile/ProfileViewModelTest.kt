...
class ProfileViewModelTest {
    ...
    @Test
    fun the_only_admin_is_told_they_cannot_leave() = runTest(testDispatcher) {
    ...
    @Test
    fun an_admin_with_another_admin_beside_them_can_leave() = runTest(testDispatcher) {
        everySuspend { getCurrentUser() } returns emma
    ...
    @Test
    fun a_member_who_is_not_an_admin_can_always_leave() = runTest(testDispatcher) {
    ...
    @Test
    fun signing_out_forgets_the_token_and_says_so() = runTest(testDispatcher) {
        everySuspend { getCurrentUser() } returns emma
        everySuspend { listHouseholdMembers() } returns listOf(emma, liam)
