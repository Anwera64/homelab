...
class InviteCreateViewModelTest {
    ...
    @Test
    fun a_name_and_a_tap_make_a_code_that_counts_down() = runTest(testDispatcher) {
    ...
    @Test
    fun a_blank_name_is_answered_with_words_rather_than_a_dead_button() = runTest(testDispatcher) {
        val viewModel = viewModel()
    ...
    @Test
    fun inviting_a_name_the_household_already_has_lands_under_the_field() = runTest(testDispatcher) {
    ...
    @Test
    fun an_admin_can_invite_another_admin() = runTest(testDispatcher) {
    ...
    @Test
    fun a_code_nobody_used_runs_out_and_a_new_one_replaces_it() = runTest(testDispatcher) {
        ...
        assertEquals(invite.code, viewModel.uiState.value.invite?.code)
    }
