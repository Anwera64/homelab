...
class PinApproveViewModelTest {
    ...
    @Test
    fun their_own_pin_produces_a_code_to_read_out() = runTest(testDispatcher) {
    ...
    @Test
    fun a_wrong_pin_says_how_many_tries_are_left_and_clears_the_field() = runTest(testDispatcher) {
    ...
    @Test
    fun too_many_wrong_pins_count_down_and_ignore_the_pad() = runTest(testDispatcher) {
