...
class ResetPinViewModelsTest {
    ...
    @Test
    fun the_code_is_upper_cased_and_carried_to_the_new_pin() = runTest(testDispatcher) {
    ...
    @Test
    fun the_new_pin_has_to_be_typed_the_same_way_twice() = runTest(testDispatcher) {
    ...
    @Test
    fun the_hub_takes_the_new_pin_and_signs_them_in() = runTest(testDispatcher) {
    ...
    @Test
    fun too_much_guessing_counts_down() = runTest(testDispatcher) {
