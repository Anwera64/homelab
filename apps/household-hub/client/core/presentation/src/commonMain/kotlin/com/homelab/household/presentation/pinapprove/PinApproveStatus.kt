...
sealed interface PinApproveStatus {
    ...
    data class WrongPin(val attemptsLeft: Int) : PinApproveStatus

    data class Locked(val secondsLeft: Int) : PinApproveStatus

    /** Done: read this out to them. It works once. */
    data class Approved(val code: String) : PinApproveStatus
