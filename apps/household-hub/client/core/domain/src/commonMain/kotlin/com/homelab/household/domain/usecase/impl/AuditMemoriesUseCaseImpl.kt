...
class AuditMemoriesUseCaseImpl(private val memoryRepository: MemoryRepository) : AuditMemoriesUseCase {
    override suspend operator fun invoke(scope: MemoryScope?): List<AgentMemory> =
