...
class MembersUseCasesTest {
    ...
    @Test
    fun looking_up_an_invite_asks_the_hub_for_the_preview() =
        runTest {
    ...
    @Test
    fun a_blank_invite_code_never_reaches_the_hub() =
        runTest {
    ...
    @Test
    fun joining_a_household_sends_the_trimmed_name_the_pin_and_the_colour() =
        runTest {
    ...
    @Test
    fun joining_needs_a_code_a_name_and_a_six_digit_pin() =
        runTest {
    ...
    @Test
    fun redeeming_a_pin_reset_signs_the_member_in() =
        runTest {
    ...
    @Test
    fun redeeming_a_pin_reset_needs_a_code_and_a_six_digit_pin() =
        runTest {
    ...
    @Test
    fun listing_household_members_asks_the_hub() =
        runTest {
    ...
    @Test
    fun creating_an_invite_sends_the_trimmed_name_and_admin_flag() =
        runTest {
    ...
    @Test
    fun a_blank_invited_name_never_reaches_the_hub() =
        runTest {
    ...
    @Test
    fun approving_a_pin_reset_confirms_with_the_approvers_own_pin() =
        runTest {
    ...
    @Test
    fun a_wrong_approver_pin_reaches_the_caller_as_it_came_from_the_hub() =
        runTest {
    ...
    @Test
    fun approving_needs_a_member_id_and_a_six_digit_pin() =
        runTest {
    ...
    @Test
    fun changing_a_pin_sends_both_pins() =
        runTest {
    ...
    @Test
    fun changing_a_pin_needs_two_six_digit_pins() =
        runTest {
    ...
    @Test
    fun removing_a_member_asks_the_hub() =
        runTest {
    ...
    @Test
    fun a_blank_member_id_never_reaches_the_hub_when_removing() =
        runTest {
    ...
    @Test
    fun leaving_the_household_confirms_with_the_members_own_pin() =
        runTest {
    ...
    @Test
    fun leaving_needs_a_six_digit_pin() =
        runTest {
