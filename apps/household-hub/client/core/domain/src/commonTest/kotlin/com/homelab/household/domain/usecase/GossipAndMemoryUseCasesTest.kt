...
class GossipAndMemoryUseCasesTest {
    ...
    @Test
    fun list_milestones_returns_active_milestones() =
        runTest {
    ...
    @Test
    fun revoke_milestone_delegates_to_repo() =
        runTest {
    ...
    @Test
    fun revoke_milestone_with_blank_id_throws_validation_error() =
        runTest {
    ...
    @Test
    fun audit_memories_returns_memories_list() =
        runTest {
    ...
    @Test
    fun revoke_memory_delegates_to_repo() =
        runTest {
