...
class MembersUiStateProvider : PreviewParameterProvider<MembersUiState> {
    ...
    private val emma = MemberRow(id = "emma", name = "Emma Larsson", avatarColor = "#3C6E4E", isYou = true, isAdmin = true)
    private val liam = MemberRow(id = "liam", name = "Liam", avatarColor = "#C05638", isYou = false, isAdmin = false)

    private val named = listOf(
        "Seen by the admin" to MembersUiState(rows = listOf(emma, liam), youAreAdmin = true, status = MembersStatus.Ready),
        "Seen by a member" to MembersUiState(
