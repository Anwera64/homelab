...
enum class HearthIcon(
    ...
    Household(
        "household",
        strokes("M3.6 10.4 12 3.8l8.4 6.6", "M5.8 9.2V19a1.4 1.4 0 0 0 1.4 1.4h9.6a1.4 1.4 0 0 0 1.4-1.4V9.2"),
    ),
    Schedule("schedule", strokes(rect(3.5, 5.5, 17.0, 15.0, 3.2), "M8.2 3.2v4M15.8 3.2v4M3.5 10.4h17")),
    Chats(
        "chats",
        strokes(
            "M4 6.6A2.6 2.6 0 0 1 6.6 4h10.8A2.6 2.6 0 0 1 20 6.6v7.6a2.6 2.6 0 0 1-2.6 2.6H9.4l-4.2 3.4a.7.7 0 0 1-1.2-.5Z",
        ),
    ),
    MySpace(
        "mySpace",
    ...
    Attach(
        "attach",
        strokes(
            "M17.2 11.2 11.4 17a3.8 3.8 0 0 1-5.4-5.4l6.6-6.6a2.5 2.5 0 0 1 3.6 3.6l-6.5 6.5a1.3 1.3 0 0 1-1.8-1.8l5.8-5.8",
        ),
    ),
    ...
    ToolGeneric(
        "toolGeneric",
        strokes(
            "M14.8 4.4a4.6 4.6 0 0 0-6 6l-5.2 5.2a1.6 1.6 0 0 0 0 2.3l1.5 1.5a1.6 1.6 0 0 0 2.3 0l5.2-5.2a4.6 4.6 0 0 0 6-6l-2.8 2.8-2.6-.7-.7-2.6Z",
        ),
    ),
    ...
    HubOnline(
        "hubOnline",
        strokes("M5.2 12.8a9.4 9.4 0 0 1 13.6 0M8.4 16a5 5 0 0 1 7.2 0") + solids(circle(12.0, 19.2, 1.3)),
    ),
    HubOffline(
        "hubOffline",
    ...
    Settings(
        "settings",
        strokes("M3.6 7.8h8.6M17.4 7.8h3M3.6 16.2h3M11.8 16.2h8.6", circle(14.8, 7.8, 2.4), circle(9.0, 16.2, 2.4)),
    ),
    SignOut(
        "signOut",
        strokes(
