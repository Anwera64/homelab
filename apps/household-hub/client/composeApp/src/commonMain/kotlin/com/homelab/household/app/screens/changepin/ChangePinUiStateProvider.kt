...
class ChangePinUiStateProvider : PreviewParameterProvider<ChangePinUiState> {
    private val named =
        listOf(
            ...
            "Wrong current PIN" to
                ChangePinUiState(new = "864209", again = "864209", currentError = CurrentPinError.Wrong(4)),
            "The two new PINs differ" to
                ChangePinUiState(current = "135790", new = "864209", again = "864200", againMismatch = true),
            "A PIN that is not six digits" to
                ChangePinUiState(current = "135790", new = "864", newError = PinError.NotSixDigits),
            "Locked" to
                ChangePinUiState(new = "864209", again = "864209", status = ChangePinStatus.Locked(secondsLeft = 30)),
            "Hub unreachable" to
                ChangePinUiState(
                    current = "135790",
                    new = "864209",
                    again = "864209",
                    status = ChangePinStatus.Unreachable,
                ),
        )
