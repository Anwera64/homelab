...
class SliceTwoComponentsTest {
    @Test
    fun a_pin_field_takes_six_digits_and_nothing_else() =
        runComposeUiTest {
            var pin = ""
            setContent {
                StillTheme {
    ...
    @Test
    fun a_pin_field_never_grows_past_six_digits() =
        runComposeUiTest {
            var pin = "482913"
            setContent {
                StillTheme {
    ...
    @Test
    fun code_boxes_upper_case_what_is_typed_and_stop_at_six() =
        runComposeUiTest {
            var code = ""
            setContent {
                StillTheme {
    ...
    @Test
    fun code_boxes_draw_a_box_per_character_typed() =
        runComposeUiTest {
            setContent {
                StillTheme {
    ...
    @Test
    fun a_code_card_shows_the_code_and_how_long_it_lasts() =
        runComposeUiTest {
            setContent {
                StillTheme {
    ...
    @Test
    fun consequence_cards_list_what_goes_and_what_stays() =
        runComposeUiTest {
            setContent {
                StillTheme {
                    ConsequenceCards(
    ...
    @Test
    fun a_switch_reports_the_value_it_would_become() =
        runComposeUiTest {
            var admin = false
            setContent {
                StillTheme {
                    HearthSwitch(
                        ...
                        contentDescription = "Household admin",
                    )
                }
            }
    ...
    @Test
    fun a_settings_row_opens_what_it_names() =
        runComposeUiTest {
            var opened = 0
            setContent {
                StillTheme {
    ...
    @Test
    fun a_row_that_cannot_be_opened_says_why_and_does_nothing() =
        runComposeUiTest {
            var opened = 0
            setContent {
                StillTheme {
    ...
    @Test
    fun a_taken_colour_cannot_be_chosen() =
        runComposeUiTest {
            var chosen = "#3C6E4E"
            setContent {
                StillTheme {
    ...
    @Test
    fun a_free_colour_can_be_chosen() =
        runComposeUiTest {
            var chosen = "#3C6E4E"
            setContent {
                StillTheme {
